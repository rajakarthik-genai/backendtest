...
from src.core.database import get_db_clients as _get_db_clients
...
# Database clients dependency
async def get_db_clients() -> Dict[str, Any]:
    """Get all database clients for API endpoints"""
    return await _get_db_clients()
