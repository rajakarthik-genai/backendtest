...
async def chat_completions(
    ...
    try:
        ...
        patient_id = request.user or (current_user.patient_id if current_user else "anonymous")
        ...
        if request.stream:
            ...
            return StreamingResponse(
                stream_chat_response(orchestrator, patient_id, session_id, user_message, request),
